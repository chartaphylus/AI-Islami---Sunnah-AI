...
const KUTUBUT_TISAH_SLUGS = [
    'bukhari', 'muslim', 'nasai', 'abu-daud', 'tirmidzi',
...
export default function OtherCollectionsPage() {
    ...
    // Helper for gradient colors (random or hashed based on name later, specific for common ones)
    const getBookColor = (id: string) => {
        if (id.includes('arbain')) return "from-blue-500 to-indigo-500";
        if (id.includes('riyadhus')) return "from-emerald-500 to-teal-500";
        if (id.includes('bulughul')) return "from-purple-500 to-pink-500";
